package com.humaxdigital.automotive.statusbar.droplist.util;
...
public class OSDPopup {
    ...
    static public void send(Context context, String text) {
        ...
        String channelid =  "DropListPopup";
        NotificationChannel channel = 
            new NotificationChannel(channelid,  "DropListPopup", NotificationManager.IMPORTANCE_LOW);
